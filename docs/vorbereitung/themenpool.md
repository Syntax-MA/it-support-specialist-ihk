...
!!! tip "Kriterium"
    Du solltest das Ticket in 2 Sätzen zusammenfassen können.
...
!!! tip "Kriterium"
    Es muss ein messbares Ergebnis geben.
...
!!! tip "Kriterium"
    Wenn du alle 5 Fragen beantworten kannst, hast du dein Thema.
...
!!! success "6+ Häkchen"
    Gutes Thema, loslegen!

!!! warning "4-5 Häkchen"
    Überlege, ob du den Scope anpassen kannst.

!!! danger "Unter 4 Häkchen"
